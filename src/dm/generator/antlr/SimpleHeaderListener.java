...
public interface SimpleHeaderListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SimpleHeaderParser#parse}.
	 * @param ctx the parse tree
	 */
	void enterParse(SimpleHeaderParser.ParseContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleHeaderParser#parse}.
	 * @param ctx the parse tree
	 */
	void exitParse(SimpleHeaderParser.ParseContext ctx);
	/**
	 * Enter a parse tree produced by {@link SimpleHeaderParser#parse_var}.
	 * @param ctx the parse tree
	 */
	void enterParse_var(SimpleHeaderParser.Parse_varContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleHeaderParser#parse_var}.
	 * @param ctx the parse tree
	 */
	void exitParse_var(SimpleHeaderParser.Parse_varContext ctx);
	/**
	 * Enter a parse tree produced by {@link SimpleHeaderParser#parse_var_out}.
	 * @param ctx the parse tree
	 */
	void enterParse_var_out(SimpleHeaderParser.Parse_var_outContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleHeaderParser#parse_var_out}.
	 * @param ctx the parse tree
	 */
	void exitParse_var_out(SimpleHeaderParser.Parse_var_outContext ctx);
	/**
	 * Enter a parse tree produced by {@link SimpleHeaderParser#cond_parse_var}.
	 * @param ctx the parse tree
	 */
	void enterCond_parse_var(SimpleHeaderParser.Cond_parse_varContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleHeaderParser#cond_parse_var}.
	 * @param ctx the parse tree
	 */
	void exitCond_parse_var(SimpleHeaderParser.Cond_parse_varContext ctx);
	/**
	 * Enter a parse tree produced by {@link SimpleHeaderParser#condition}.
	 * @param ctx the parse tree
	 */
	void enterCondition(SimpleHeaderParser.ConditionContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleHeaderParser#condition}.
	 * @param ctx the parse tree
	 */
	void exitCondition(SimpleHeaderParser.ConditionContext ctx);
}